...
st.set_page_config(layout = "centered", page_title='Spiral Symplectic Report processing tool', page_icon='https://github.com/yusufaliozkan/volume_report/blob/main/Ilogo.PNG?raw=true')
